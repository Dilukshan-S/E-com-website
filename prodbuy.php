<?php
  ...
  */
   ...
   *the code commented below is used to display all the products 
   */
  ...
  while ($arrayp=mysqli_fetch_array($exeSQL))
  {
    ...
    echo "<td style='border: 0px'>";//make the image into an anchor to prodbuy.php and pass the product id by URL (the id from the array)
    ...
    echo "<p>".$arrayp['prodDescripLong']."</p><br>"; //display description
    echo "<p><b>$" . $arrayp['prodPrice'] . "</b></p><br>";
    echo "<p>Left in Stock: ".$arrayp['prodQuantity'];//for quantity left in stock
